...
На стадии \ABMLString{string type} нетривиальным случаем является приведение строки к типу среза \ABMLAttribute{byte}. Напомню, что этот тип является аналогом \ABMLAttribute{uint8}.
...
На стадии \ABMLString{complex eval im}
\begin{ABMLCode}
